...
/**
 * DepositServlet - Handles deposit operations
 */
public class DepositServlet extends HttpServlet {
    ...
    public void init() {
        ...
        System.out.println("[DepositServlet] Initialized");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("[DepositServlet] Processing deposit");
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Deposit Success</title>");
            ...
            out.println("<p><strong>Amount Deposited:</strong> ₹" + amount + "</p>");
            out.println("<p><strong>Previous Balance:</strong> ₹" + account.getBalance() + "</p>");
            out.println("<p><strong>New Balance:</strong> ₹" + newBalance + "</p>");
            out.println("</div>");
            out.println("</div>");
            out.println("<p><a href='deposit.html' class='btn'>Make Another Deposit</a></p>");
            out.println("<p><a href='index.html' class='btn'>Home</a></p>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");

            System.out.println("[DepositServlet] Deposit successful: ₹" + amount + " to account " + accountNumber);
    ...
    private void showError(PrintWriter out, String message) {
        ...
        out.println("<p><a href='deposit.html' class='btn'>← Try Again</a></p>");
        out.println("</div>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
